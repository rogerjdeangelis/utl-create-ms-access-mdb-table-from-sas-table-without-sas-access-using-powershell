# utl-create-ms-access-mdb-table-from-sas-table-without-sas-access-using-powershell
Create ms access mdb table from sas table without sas access using powershell
    ...
    https://tinyurl.com/2azm47wd
    https://github.com/rogerjdeangelis/utl-export-ms-access-table-from-mdb-database-to-sas-table-without-sas-access-using-powershell/blob/main/simple
